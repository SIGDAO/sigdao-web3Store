<script>
    ...
    import { Page, TokenItem, TokenItemVariant, feeStore, ActivePaymentQrCode } from '../_common'
    ...
    <div class="form">
        <div class="form--header">
            <p class="mdc-typography--body1">
                Before you can receive your first voting, the token must be activated. Unfortunately, there is a
